...
class OBlokk(Blokk):
    def __init__(self) -> None:
        ...
        self._cellak = {
            0:[Pozicio(0, 0), Pozicio(0, 1), Pozicio(1, 0), Pozicio(1, 1)]
        }
        self.mozgat(0, 4)
...
class NagyOBlokk(Blokk):
    def __init__(self) -> None:
        ...
        self._cellak = {
            0:[Pozicio(0, 0), Pozicio(0, 1), Pozicio(0, 2), Pozicio(1, 0), Pozicio(1, 1), Pozicio(1, 2), Pozicio(2, 0), Pozicio(2, 1), Pozicio(2, 2)],
        }
        self.mozgat(0, 3)